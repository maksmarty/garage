...
return array(
    'records_per_page' => 20,
    'api_limit' => 20,
    'image_sizes' => array('100','400'),
    'categories' => array(
        'american'=> array('cadillac','dodgenchrysler','chevrolet','gmc','fordnlincoln','hummer','jeep'),
        'european'=> array('mercedes','bmw','rangerover','volvowagon','jaguar','porsche','audi','peugeot','skoda','mini','renault','volvo'),
        'asian'=>  array('toyota','nissan','lexus','infiniti','honda','hyundai','kia','mitsubishi','suzuki','mazda','isuza','subaru','sheri'),
