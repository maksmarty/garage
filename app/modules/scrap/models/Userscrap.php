...
namespace App\Modules\Scrap\Models;
...
class Userscrap extends \Eloquent {
	 ...
	 * @var string
	 */
	protected $table = "user_scrap";
	protected $guarded = ["user_scrap_id"];
    protected $primaryKey = 'user_scrap_id';
