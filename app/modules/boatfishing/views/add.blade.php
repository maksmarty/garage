...
<!-- Set the title here -->
@section('title')    
    <title>Add Boat | Boat Fishing</title>
@stop	
 
<!-- Set the breadcrumb here -->
@section('breadcrumb')   
    <li>Home</li><li>Add Boat</li>
@stop
            ...
            <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false">
                ...
                <div>
                    ...
                    <div class="widget-body">
                        ...
                        @if($item->boat_fishing_id)
                            <form class="form-horizontal" name="addUpdateBoatForm" id="addUpdateBoatForm" method="post" action="{{route('boatfishing.post.update',$item->boat_fishing_id)}}" enctype="multipart/form-data">
                        @else
                            <form class="form-horizontal" name="addUpdateBoatForm" id="addUpdateBoatForm" method="post" action="{{route('boatfishing.post.add')}}" enctype="multipart/form-data">
                        @endif
                                    ...
                                    @if($photos)
                                        ...
                                        @foreach ($photos as $photo)
                                            ...
                                            <div class="row" style="padding: 10px;">
                                                ...
                                                <div class="col-md-2">
                                                <img src="{{Helpers::build_image ( $photo->photo_name, 'boatfishing', '100' )}}">
                                                </div>
                                            </div>
