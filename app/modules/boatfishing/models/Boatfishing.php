...
namespace App\Modules\Boatfishing\Models;
...
class Boatfishing extends \Eloquent {
	 ...
	 * @var string
	 */
	protected $table = "boat_fishing";
	protected $guarded = ["boat_fishing_id"];
    protected $primaryKey = 'boat_fishing_id';
