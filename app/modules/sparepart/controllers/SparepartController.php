...
namespace App\Modules\Sparepart\Controllers;

use App\Modules\Sparepart\Models\Sparepart;
...
//         }
    ...
    public function index()
    {
        ...
        return View::make('sparepart::index');
    }
    ...
    public function showAdd(){
        ...
        return View::make('sparepart::add', array('make'=> $list , 'item' => new Sparepart() ));
    }
    ...
    public function postAdd(){
        ...
        if ($validator->fails()) {
            ...
            return Redirect::route('sparepart.add')
            ...
            return Redirect::to(sprintf('%s/%s', 'sparepart','add'));
        }
    }
...
//    }
    ...
    public function getLoadView($formType, $data, $section = NULL) {
        $html = View::make('sparepart::lists', $data)->render();
