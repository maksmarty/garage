...
<!-- Set the title here -->
@section('title')    
    <title>Garage | Spare Parts</title>
@stop
...
<div class="row">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-6">
            <h1 class="page-title txt-color-blueDark">
                ...
                <strong> List Spare Parts : </strong>
                <span>
                    Add/Update listed Spare Parts here.
                </span>
            </h1>
        </div>        
    </div>
            ...
            <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false">
                    ...
                    <div class="col-xs-12 col-sm-12">
                        ...
                        <span class="input-group-addon">
                            <i class="glyphicon glyphicon-search"></i>
                                ...
                                <input type="text" id="filter__sparepart_list" name="filter__sparepart_list" class="search fr form-control" placeholder="Search by phone ..." />
                            </label>


                            <label class="pull-right">

                                <a class="btn btn-success" href="{{route('sparepart.add')}}">
                ...
                <div>
                    ...
                    @include('layout::partials.alerts.message')
                            ...
                            <!-- widget content -->
                    <div id = "list__sparepart_list"></div>
                    <!-- end widget content -->
                </div>
                <!-- end widget div -->
