...
namespace App\Modules\Marine\Models;
...
class Marinemakeregion extends \Eloquent {
	 ...
	 * @var string
	 */
	protected $table = "marine_make_region";
	protected $guarded = ["marine_make_region_id"];
    protected $primaryKey = 'marine_make_region_id';
