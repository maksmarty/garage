...
<!-- Set the title here -->
@section('title')    
    <title>Garage | Service Center</title>
@stop
...
@section('breadcrumb')   
    <li>Home</li><li>Service Center</li>
@stop
...
<div class="row">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-6">
            <h1 class="page-title txt-color-blueDark">
                ...
                <strong> List Service Center : </strong>
                <span>
                    Add/Update listed Service Center here.
                </span>
            </h1>
        </div>        
    </div>
            ...
            <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false">
                    ...
                    <div class="col-xs-12 col-sm-12">
                        ...
                        <span class="input-group-addon">
                            <i class="glyphicon glyphicon-search"></i>
                                ...
                                <input type="text" id="filter__servicecenter_list" name="filter__servicecenter_list" class="search fr form-control" placeholder="Search by phone ..." />
                            </label>


                            <label class="pull-right">

                                <a class="btn btn-success" href="{{route('servicecenter.add')}}">
                                    <i class="fa fa-plus"></i> <span class="hidden-mobile">Add New Car</span>
                                </a>
                            </label>
                ...
                <div>
                    ...
                    @include('layout::partials.alerts.message')
                            ...
                            <!-- widget content -->
                    <div id = "list__servicecenter_list"></div>
                    <!-- end widget content -->
                </div>
                <!-- end widget div -->
