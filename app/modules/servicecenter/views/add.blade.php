...
<!-- Set the title here -->
@section('title')    
    <title>Garage | Add Service Center</title>
@stop	
 
<!-- Set the breadcrumb here -->
@section('breadcrumb')   
    <li>Home</li><li>Add Service Center</li>
@stop
        ...
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-6">
            <h1 class="page-title txt-color-blueDark">
                ...
                @if($item->spare_part_id)
                    <strong> Update Service Center : </strong>
                    <span>
                        Update Service Center here.
                    </span>
                @else
                    <strong> Add Service Center : </strong>
                    <span>
            ...
            <div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false">
                ...
                <div>
                    ...
                    <div class="widget-body">
                        ...
                        @if($item->service_center_id)
                            <form class="form-horizontal" name="addUpdateServiceCenterForm" id="addUpdateServiceCenterForm" method="post" action="{{route('servicecenter.post.update',$item->service_center_id)}}" enctype="multipart/form-data">
                        @else
                            <form class="form-horizontal" name="addUpdateServiceCenterForm" id="addUpdateServiceCenterForm" method="post" action="{{route('servicecenter.post.add')}}" enctype="multipart/form-data">
                        @endif
                        ...
                        @include('layout::partials.alerts.message')
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="hidden" name="service_center_id" id="service_center_id" value="">
