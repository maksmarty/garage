 ...
 * Descripttion : Contaion Registration form.
 */
?>
<!DOCTYPE html>
<html lang="en-us" id="extr-page">
	...
	<body id="login">
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile">Already registered?</span> {{ HTML::link('/login', 'Sign In', array('class' => 'btn btn-danger'))}} </span>
