...
<!-- Set the title here -->
@section('title')    
    <title> {{ucfirst($firstSeg)}} | Garage</title>
@stop
...
@section('breadcrumb')   
    <li>Home</li><li>{{ucfirst($firstSeg)}}</li>
@stop
...
<div class="row">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-6">
            <h1 class="page-title txt-color-blueDark">
                ...
                <strong> List {{ucfirst($firstSeg)}} : </strong>
                <span>
                    Add/Update listed {{ucfirst($firstSeg)}} here.
                </span>
            </h1>
        </div>        
    </div>
                ...
                <div class="dt-toolbar">
                    <div class="col-xs-12 col-sm-12">
                        ...
                        <span class="input-group-addon">
                            ...
                            <label class="pull-left col-sm-3">

                                {{ Form::select('filter__category', $categories, null, ['class' => 'form-control','required' => 'required','id' => 'filter__category']) }}
                            ...
                            <label class="pull-right">
                                ...
                                <a class="btn btn-success" href="{{route( $firstSeg .'.add')}}">
                                    <i class="fa fa-plus"></i> <span class="hidden-mobile">Add New {{ucfirst($firstSeg)}}</span>
                                </a>
                            </label>
