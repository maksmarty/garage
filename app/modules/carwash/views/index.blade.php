...
<div class="row">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-6">
            <h1 class="page-title txt-color-blueDark">
                ...
                <strong> List car wash : </strong>
                <span>
                    Add/Update listed car wash here.
                </span>
            </h1>
        </div>        
    </div>
                    ...
                    <div class="col-xs-12 col-sm-12">
                        ...
                        <span class="input-group-addon">
                            <i class="glyphicon glyphicon-search"></i>
                                ...
                                <input type="text" id="filter__carwash_list" name="filter__carwash_list" class="search fr form-control" placeholder="Search by phone ..." />
                            </label>


                            <label class="pull-right">

                                <a class="btn btn-success" href="{{route('carwash.add')}}">
                                    <i class="fa fa-plus"></i> <span class="hidden-mobile">Add New Car Wash</span>
                                </a>
                            </label>
