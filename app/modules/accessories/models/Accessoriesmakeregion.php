...
namespace App\Modules\Accessories\Models;
...
class Accessoriesmakeregion extends \Eloquent {
	 ...
	 * @var string
	 */
	protected $table = "accessories_make_region";
	protected $guarded = ["accessories_make_region_id"];
    protected $primaryKey = 'accessories_make_region_id';
